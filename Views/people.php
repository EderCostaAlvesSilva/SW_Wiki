...
<body>
    ...
    <script>
        ...
        async function renderPeople(data) {
            ...
            const lastPart = homeworld.split('/').slice(-2).join('/');
            const homeworldInfo = await fetchOuthers(lastPart);

            const homeworldHtml = `
        <a class="btn btn-outline-warning" href="${homeworldInfo.link}" target="_self">${homeworldInfo.nome}</a>
    `;
                ...
                <div class="card shadow-lg border-warning bg-black text-light">
                    ...
                    <div class="card-body">
                        <section class="details">
                            <h4>Information</h4>
                            <ul>
                                <li><strong>Height:</strong> <span>${height} cm</span></li>
                                <li><strong>Mass:</strong> <span>${mass} kg</span></li>
                                <li><strong>Hair Color:</strong> <span>${hair_color}</span></li>
                                <li><strong>Skin Color:</strong> <span>${skin_color}</span></li>
                                <li><strong>Eye Color:</strong> <span>${eye_color}</span></li>
                                <li><strong>Birth Year:</strong> <span>${birth_year}</span></li>
                                <li><strong>Gender:</strong> <span>${gender}</span></li>
                            </ul>
                        </section>

                        <section class="homeworld">
                            <h4>Homeworld</h4>
                            <p>${homeworldHtml}</p>
                        </section>
