            ...
            const card = `
                <div class="card shadow-lg border-warning bg-black text-light">
                    <div class="card-header bg-dark text-warning text-center">
                        <h3>Planet Name: <span>${name}</span></h3>
                    </div>
                    <div class="card-body">
                        <section class="details">
                            <h4>Planet Information</h4>
                            <ul>
                                <li><strong>Diameter:</strong> <span>${diameter}</span></li>
                                <li><strong>Rotation Period:</strong> <span>${rotation_period}</span></li>
                                <li><strong>Orbital Period:</strong> <span>${orbital_period}</span></li>
                                <li><strong>Gravity:</strong> <span>${gravity}</span></li>
                                <li><strong>Population:</strong> <span>${population} inhabitants</span></li>
                                <li><strong>Climate:</strong> <span>${climate}</span></li>
                                <li><strong>Terrain:</strong> <span>${terrain}</span></li>
                                <li><strong>Surface Water:</strong> <span>${surface_water} %</span></li>
                            </ul>
                        </section>
